...
APP_TITLE	:=	InvadersNX
APP_AUTHOR	:=	MaesterRowen
...
BUILD		:=	build
ASSETS		:=  assets
SOURCES		:=	source strata source/game source/states source/entities
DATA		:=	data
...
LIBS	:= -lSDL2_mixer -lmodplug -lmpg123 -lvorbisidec -logg -lSDL2_image -lpng -lturbojpeg -lSDL2 -lnx -lm `sdl2-config --libs` `freetype-config --libs`
